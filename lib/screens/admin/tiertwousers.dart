...
class Tier2Users extends StatefulWidget {
  const Tier2Users({super.key});

  @override
  State<Tier2Users> createState() => _Tier2UsersState();
}

class _Tier2UsersState extends State<Tier2Users> {
  List<dynamic> users = [];

  @override
  void initState() {
    super.initState();
    UserService.getAllTier2Users()
        .then((res) => setState(() {
