...
class AwardedDetail extends StatefulWidget {
  const AwardedDetail({super.key});

  @override
  State<AwardedDetail> createState() => _AwardedDetailState();
}

class _AwardedDetailState extends State<AwardedDetail> {
  List members = [];
  ...
  void addButtonPressed() {
    if (userInfo['_id'] == projectInfo['creator']) {
      Navigator.push(
        context,
        MaterialPageRoute(
  ...
  void getProjectMembers() {
    ProjectService.getAllProjectMembers(projectInfo['_id'])
        .then((res) => setState(() {
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    TextUtil(
                                      text: DateFormat('yyyy.MM.dd').format(
                                          DateTime.parse(projectInfo['start'])),
                                      weight: true,
                                      size: 15,
                                      color: Colors.green,
                                    ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TextUtil(
                                      text:
                                          '\$${getTotal(projectInfo['amount'], projectInfo['number'])}',
                                      weight: true,
                                      size: 15,
                                      color: Colors.green,
                                    ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    TextUtil(
                                      text:
                                          '\$${getTotal(getTotal(projectInfo['amount'], projectInfo['number']), projectInfo['number'])}',
                                      size: 15,
                                      weight: true,
                                      color: Colors.cyan,
                                    ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        if ((projectInfo['paid_members']
                                                    as Map<String, dynamic>?)
                                                ?.keys
                                                .where((key) =>
                                                    (projectInfo['paid_members']
                                                        as Map<String,
                                                            dynamic>?)?[key] ==
                                                    'awarded')
                                                .toList()
            ...
            TextButton(
              ...
              onPressed: () {
                ProjectService.addProjectMember(
                        userInfo['_id'], projectInfo['_id'], 'joining')
                    .then((res) =>
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ProjectService.updateProjectMember(
                        projectInfo['_id'], members[index]['_id'], 'denied')
                    .then((res) => {
            ...
            TextButton(
              ...
              onPressed: () {
                ProjectService.updateProjectMember(
                        projectInfo['_id'], members[index]['_id'], 'active')
                    .then((res) => {
                          if (res.statusCode == 200)
                            setState(() {
